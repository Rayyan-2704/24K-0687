...
{ 
  ...
  // Although the roll numbers start from 0, the mapping should have been 0 for Section A & 1 for Section B so on, but the question says that 1 is for Section A
